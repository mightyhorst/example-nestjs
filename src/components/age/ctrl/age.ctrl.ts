...
*
* @class AgeController  
* @description This is the Age of Devices controller 
*
**/
@ApiUseTags('age')
@ApiBearerAuth()
@Controller('api/v2/age')
export class AgeController {
	...
	/**
	* @name get es query 
	* @description GET /api/v2/age/{sitecode}
	...
	**/
	...
	async search(
		...
		try{
			let searchResults = await this.ageService.search(
				sitecode, 
				formFactor,
				warranty,
				ageOfDevice,
	...
	/**
	* @name get chart data 
	* @description GET /api/v2/age/{sitecode}/chart
	...
	**/
	...
	async chart(
		...
		try{
			let searchResults = await this.ageService.searchToChart(
				sitecode, 
				formFactor,
				warranty,
				ageOfDevice,
