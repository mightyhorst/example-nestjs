...
**/
import { 
	UtilisationResponseDto  as ResDto, 
	// UtilisationErrorResponseDto as ErrDto,  
	UtilisationChartResponseDto as ChartDto
} from '../dto/index';
import { 
...
*
**/
@ApiUseTags('utilisation')
@ApiBearerAuth()
@Controller('api/v2/utilisation')
export class UtilisationController {
	...
	/**
	* @name get es query 
	* @description GET /api/v2/utilisation/{sitecode}
	...
	**/
	...
	async search(
		...
		try{
			let searchResults = await this.utilisationService.search(
				sitecode, 
				formFactor,
				warranty,
				ageOfDevice,
	...
	/**
	* @name get chart data 
	* @description GET /api/v2/utilisation/{sitecode}/chart
	...
	**/
	...
	async chart(
		...
		try{
			let searchResults = await this.utilisationService.searchToChart(
				sitecode, 
				formFactor,
				warranty,
				ageOfDevice,
